function [result] = triangular_local_basis(x, y, vertices, basis_type, basis_index, derivative_degree_x, derivative_degree_y)
...
elseif derivative_degree_x == 1 && derivative_degree_y == 0
    result = (triangular_reference_basis(x_hat,y_hat,basis_type,basis_index,1,0)*J_22+triangular_reference_basis(x_hat,y_hat,basis_type,basis_index,0,1)*(-J_21))/J_det;
elseif derivative_degree_x == 0 && derivative_degree_y == 1
    result = (triangular_reference_basis(x_hat,y_hat,basis_type,basis_index,1,0)*(-J_12)+triangular_reference_basis(x_hat,y_hat,basis_type,basis_index,0,1)*J_11)/J_det;
elseif derivative_degree_x == 2 && derivative_degree_y == 0
    result = (triangular_reference_basis(x_hat,y_hat,basis_type,basis_index,2,0)*J_22^2+triangular_reference_basis(x_hat,y_hat,basis_type,basis_index,0,2)*J_21^2+triangular_reference_basis(x_hat,y_hat,basis_type,basis_index,1,1)*(-2*J_21*J_22))/J_det^2;
elseif derivative_degree_x == 0 && derivative_degree_y == 2
    result = (triangular_reference_basis(x_hat,y_hat,basis_type,basis_index,2,0)*J_12^2+triangular_reference_basis(x_hat,y_hat,basis_type,basis_index,0,2)*J_11^2+triangular_reference_basis(x_hat,y_hat,basis_type,basis_index,1,1)*(-2*J_11*J_12))/J_det^2;
elseif derivative_degree_x == 1 && derivative_degree_y == 1
    result = (triangular_reference_basis(x_hat,y_hat,basis_type,basis_index,2,0)*(-J_22*J_12)+triangular_reference_basis(x_hat,y_hat,basis_type,basis_index,0,2)*(-J_21*J_11)+triangular_reference_basis(x_hat,y_hat,basis_type,basis_index,1,1)*(J_21*J_12+J_11*J_22))/J_det^2;
end
