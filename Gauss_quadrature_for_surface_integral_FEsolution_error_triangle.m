function [result] = Gauss_quadrature_for_surface_integral_FEsolution_error_triangle(uh_local, accurate_function, vertices,...
    Gauss_weights_reference_triangle, Gauss_nodes_reference_triangle, basis_type, derivative_degree_x, derivative_degree_y)
...
for i = 1:Gpn
    result = result + Gauss_weights_local_triangle(i) * (feval(accurate_function, Gauss_nodes_local_triangle(i,1), Gauss_nodes_local_triangle(i,2))...
        - FE_solution_local_triangle(Gauss_nodes_local_triangle(i,1), Gauss_nodes_local_triangle(i,2), uh_local, vertices, basis_type, derivative_degree_x, derivative_degree_y))^2;
end
