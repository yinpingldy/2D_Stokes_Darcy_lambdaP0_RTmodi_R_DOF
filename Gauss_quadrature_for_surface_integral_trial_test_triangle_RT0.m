function result = Gauss_quadrature_for_surface_integral_trial_test_triangle_RT0(coefficient_function, Gauss_coefficient_local, Gauss_point_local, vertices,...
...
for i = 1:Gpn
     result = result + Gauss_coefficient_local(i) * feval(coefficient_function, Gauss_point_local(i,1), Gauss_point_local(i,2)) *...
         dot( triangular_RT0_local_basis(Gauss_point_local(i,1), Gauss_point_local(i,2), vertices, trial_basis_index, trial_derivative_degree),...
         triangular_RT0_local_basis(Gauss_point_local(i,1), Gauss_point_local(i,2), vertices, test_basis_index, test_derivative_degree) );
end