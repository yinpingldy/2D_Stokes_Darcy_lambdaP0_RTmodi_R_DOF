function [result] = FE_solution_error_triangle_u_domain(exact_solution, uh, index_u, domain, domain_t, P_partition, T_partition, number_of_elements,...
    triangle_edge, Gamma_inter_num, number_of_edges, nodes_stokes_num, nodes_stokes, Gauss_coefficient_reference_triangle, Gauss_point_reference_triangle,...
...
for n = 1:number_of_elements
    ...
    result = result + Gauss_quadrature_for_surface_integral_u_error_triangle_domain(n, uh, index_u, domain, domain_t, exact_solution, vertices,...
        T_partition, triangle_edge, Gamma_inter_num, number_of_edges, nodes_stokes_num, nodes_stokes, Gauss_coefficient_reference_triangle, Gauss_point_reference_triangle,...
        derivative_degree, basis_type, derivative_degree_x, derivative_degree_y);
