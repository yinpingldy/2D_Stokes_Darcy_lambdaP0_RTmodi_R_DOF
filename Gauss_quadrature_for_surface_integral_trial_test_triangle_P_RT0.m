function result = Gauss_quadrature_for_surface_integral_trial_test_triangle_P_RT0(coefficient_function, Gauss_coefficient_local, Gauss_point_local, vertices,...
    trial_basis_type, trial_basis_index, trial_derivative_degree_x, trial_derivative_degree_y, test_basis_index, test_derivative_degree)
...
result = 0;
for i = 1:Gpn
    basis_Q = triangular_RT0_local_basis(Gauss_point_local(i,1), Gauss_point_local(i,2), vertices, test_basis_index, test_derivative_degree);
