function result = Gauss_quadrature_for_surface_integral_test_triangle(coefficient_function, Gauss_weights_local, Gauss_nodes_local, vertices,...
...
result = 0;
for i = 1:Gpn
      result = result + Gauss_weights_local(i) * feval(coefficient_function, Gauss_nodes_local(i,1), Gauss_nodes_local(i,2))*...
          triangular_local_basis(Gauss_nodes_local(i,1), Gauss_nodes_local(i,2), vertices, test_basis_type, test_basis_index, test_derivative_degree_x, test_derivative_degree_y);
end