function [result] = Gauss_quadrature_for_line_integral_test_2D(coefficient_function, Gauss_weights_reference_1D, Gauss_nodes_reference_1D, tan_vector, lable_test,...
    end_point_1, end_point_2, test_vertices, test_basis_type, test_basis_index, test_derivative_degree_x, test_derivative_degree_y)
