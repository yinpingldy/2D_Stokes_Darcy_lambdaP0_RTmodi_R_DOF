function [result] = Gauss_quadrature_for_line_integral_trial_test_2D_RT0_L(coefficient_function, Gauss_weights_reference_1D, Gauss_nodes_reference_1D, end_point_1, end_point_2, normal_vector, lable_test,...
    trial_vertices, trial_basis_index, trial_derivative_degree, test_vertices, test_basis_type, test_basis_index, test_derivative_degree_x, test_derivative_degree_y)
...
if end_point_1(2) == end_point_2(2) % The line is horizontal.
    ...
    for i=1:Gpn
         result = result + Gauss_weights_local_1D(i) * feval(coefficient_function, Gauss_nodes_local_1D(i), end_point_1(2)) ...
             * dot(triangular_RT0_local_basis(Gauss_nodes_local_1D(i), end_point_1(2), trial_vertices, trial_basis_index, trial_derivative_degree) , normal_vector)...
             * triangular_local_basis(Gauss_nodes_local_1D(i), end_point_1(2), test_vertices, test_basis_type, test_basis_index, test_derivative_degree_x, test_derivative_degree_y) * normal_vector(lable_test)^2;
    end    
...
elseif end_point_1(1)==end_point_2(1) % The line is vertical.
    ...
    for i=1:Gpn
         result = result + Gauss_weights_local_1D(i) * feval(coefficient_function, end_point_1(1), Gauss_nodes_local_1D(i)) ...
             * dot(triangular_RT0_local_basis(end_point_1(1), Gauss_nodes_local_1D(i), trial_vertices, trial_basis_index, trial_derivative_degree) , normal_vector) ...
             * triangular_local_basis(end_point_1(1), Gauss_nodes_local_1D(i), test_vertices, test_basis_type, test_basis_index, test_derivative_degree_x, test_derivative_degree_y) * normal_vector(lable_test)^2;
    end
    ...
    for i=1:Gpn
         ...
         result = result + Gauss_weights_local_1D(i) * Jacobi * feval(coefficient_function, x, y) ...
             ...
             * triangular_local_basis(x, y, test_vertices, test_basis_type, test_basis_index, test_derivative_degree_x, test_derivative_degree_y) * normal_vector(lable_test)^2;
    end
