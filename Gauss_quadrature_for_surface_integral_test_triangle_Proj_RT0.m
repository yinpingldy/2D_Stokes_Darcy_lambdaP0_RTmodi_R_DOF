function result = Gauss_quadrature_for_surface_integral_test_triangle_Proj_RT0(coefficient_function1, coefficient_function2, Gauss_weights_local, Gauss_nodes_local, vertices, test_basis_type, test_basis_index, test_derivative_degree_x, test_derivative_degree_y, project_x_y)
...
for i = 1:Gpn
      result = result + Gauss_weights_local(i) * dot( [feval(coefficient_function1, Gauss_nodes_local(i,1), Gauss_nodes_local(i,2)) ,feval(coefficient_function2, Gauss_nodes_local(i,1), Gauss_nodes_local(i,2))] , ...
          triangular_RT0_project(Gauss_nodes_local(i,1), Gauss_nodes_local(i,2), vertices, test_basis_type, test_basis_index, test_derivative_degree_x, test_derivative_degree_y, project_x_y) );
end