function result = assemble_matrix_from_line_integral_triangle_lambda_SRT0(coefficient_function, edges, Gamma_inter_num, Gamma_inter_nodes, edge_condition, Stokes_or_Darcy_t, P_partition, T_partition, N_basis_trial,  N_basis_test, triangle_edge, number_of_edges, nodes_stokes_num,...
