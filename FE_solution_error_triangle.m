function [result] = FE_solution_error_triangle(exact_solution, uh, P_partition, T_partition, T_basis, number_of_elements, Gauss_coefficient_reference_triangle, Gauss_point_reference_triangle, basis_type, derivative_degree_x, derivative_degree_y)
...
for n = 1:number_of_elements
    ...
    result = result + Gauss_quadrature_for_surface_integral_FEsolution_error_triangle(uh_local, exact_solution, vertices,...
        Gauss_coefficient_reference_triangle, Gauss_point_reference_triangle, basis_type, derivative_degree_x, derivative_degree_y);
end
result = sqrt(result);