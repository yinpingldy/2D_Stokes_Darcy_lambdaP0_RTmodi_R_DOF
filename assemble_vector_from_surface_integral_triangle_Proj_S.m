function result = assemble_vector_from_surface_integral_triangle_Proj_S(coefficient_function1, coefficient_function2, P_partition, T_partition, N_basis_test, nodes_stokes, number_of_edges,...
...
for n = 1:number_of_elements
    ...
    for beta = 1:number_of_test_local_basis
        int_value = Gauss_quadrature_for_surface_integral_test_triangle_Proj_RT0(coefficient_function1, coefficient_function2, Gauss_coefficient_local_triangle, Gauss_point_local_triangle, vertices,...
            basis_type_test, beta, derivative_degree_x_test, derivative_degree_y_test, project_x_y);
