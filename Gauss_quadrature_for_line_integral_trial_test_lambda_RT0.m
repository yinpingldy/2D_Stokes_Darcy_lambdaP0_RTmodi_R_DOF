function [result] = Gauss_quadrature_for_line_integral_trial_test_lambda_RT0(coefficient_function, Gauss_weights_reference_1D, Gauss_nodes_reference_1D, end_point_1, end_point_2, normal_vector,...
    trial_basis_type_1D, trial_vertices_1D, trial_basis_index_1D, trial_derivative_degree_1D, test_vertices, test_basis_index, test_derivative_degree)
...
if end_point_1(2) == end_point_2(2) % The line is horizontal.
    ...
    for i=1:Gpn
         result = result + Gauss_weights_local_1D(i) * feval(coefficient_function, Gauss_nodes_local_1D(i), end_point_1(2)) ...
             * local_basis_fun_1D(Gauss_nodes_local_1D(i), trial_vertices_1D, trial_basis_type_1D, trial_basis_index_1D, trial_derivative_degree_1D)...
...
else % The slope of the edge is in (0,infinity).[Î´ÅªÇå,Î´¸Ä]
