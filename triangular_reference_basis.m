...
%basis_type=200: 2D constant FE.
% basis_type=201: 2D linear FE.
% basis_type=202: 2D Lagrange quadratic FE.
% basis_type=210: 2D Crouzeix-Raviart FE.
...
if basis_type == 200 %% 2D constant FE (P0)
    
    if derivative_degree_x==0 && derivative_degree_y==0
        result = 1;
    end

elseif basis_type == 201 %% 2D linear FE (P1)
...
elseif basis_type == 202 %% 2D Lagrange quadratic FE
...
elseif basis_type == 210  %% CR element
