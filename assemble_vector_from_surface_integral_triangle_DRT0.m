function result = assemble_vector_from_surface_integral_triangle_DRT0(coefficient_function1,coefficient_function2, P_partition, T_partition, N_basis_test, Stokes_or_Darcy_t, triangle_edge,...
