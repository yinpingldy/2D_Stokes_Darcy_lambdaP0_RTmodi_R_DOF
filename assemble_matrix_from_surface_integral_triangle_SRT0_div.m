function result = assemble_matrix_from_surface_integral_triangle_SRT0_div(coefficient_function, P_partition, T_partition, N_basis_trial, N_basis_test, Stokes_t, triangle_edge, Gamma_inter_num, number_of_edges, nodes_stokes_num,...
    number_of_trial_local_basis, number_of_elements, Gauss_weights_reference_triangle, Gauss_nodes_reference_triangle,...
...
for n=1:number_of_elements
    ...
    for alpha = 1:number_of_trial_local_basis
       i = triangle_edge(alpha,element_now);
       ...
       int_value = Gauss_quadrature_for_surface_integral_trial_test_triangle_RT0(coefficient_function,Gauss_weights_local_triangle, Gauss_nodes_local_triangle, vertices,...
           alpha, derivative_degree_trial, alpha, derivative_degree_test);
       result(i,i) = result(i,i) + int_value;
    end
