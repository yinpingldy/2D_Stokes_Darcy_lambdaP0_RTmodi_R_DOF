function result = assemble_matrix_from_surface_integral_triangle_SRT0_0(coefficient_function, P_partition, T_partition, N_basis_trial, N_basis_test, Stokes_t, triangle_edge, Gamma_stokes_num_full,...
    ...
    for alpha = 1:number_of_trial_local_basis
       for beta = 1:number_of_test_local_basis
           ...
           if any(Gamma_stokes_num_full==i) || any(Gamma_stokes_num_full==j)
               ...
               int_value = (h_T)^(-2) * Gauss_quadrature_for_surface_integral_trial_test_triangle_RT0(coefficient_function,Gauss_weights_local_triangle, Gauss_nodes_local_triangle, vertices,...
