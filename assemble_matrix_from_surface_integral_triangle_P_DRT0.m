function result = assemble_matrix_from_surface_integral_triangle_P_DRT0(coefficient_function, P_partition, T_partition, N_basis_trial, N_basis_test, T_basis_p, Stokes_or_Darcy_t, triangle_edge,...
