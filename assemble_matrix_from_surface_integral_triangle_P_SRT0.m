function result = assemble_matrix_from_surface_integral_triangle_P_SRT0(coefficient_function, P_partition, T_partition, N_basis_trial, N_basis_test, T_basis_p, Stokes_or_Darcy_t, triangle_edge, Gamma_inter_num, number_of_edges, nodes_stokes_num,...
...
for n=1:number_of_elements
    ...
    for alpha = 1:number_of_trial_local_basis
       for beta = 1:number_of_test_local_basis   
           ...
           int_value = Gauss_quadrature_for_surface_integral_trial_test_triangle_P_RT0(coefficient_function, Gauss_weights_local_triangle, Gauss_nodes_local_triangle, vertices,...
               basis_type_trial, alpha, derivative_degree_x_trial, derivative_degree_y_trial, beta, derivative_degree_test);
