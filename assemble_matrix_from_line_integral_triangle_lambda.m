function result = assemble_matrix_from_line_integral_triangle_lambda(coefficient_function, edges, Gamma_inter_num, Gamma_inter_nodes, edge_condition, Stokes_t, P_partition, T_partition, N_basis_trial, N_basis_test, nodes_stokes, number_of_edges,...
    number_of_trial_local_basis, number_of_test_local_basis, number_of_Gamma_inter, Gauss_weights_reference_1D, Gauss_nodes_reference_1D, lable_test,...
    basis_type_trial_1D, derivative_degree_1D, basis_type_test, derivative_degree_x_test, derivative_degree_y_test)
...
for n=1:number_of_Gamma_inter
    ...
    for alpha = 1:number_of_trial_local_basis 
       for beta = 1:number_of_test_local_basis
           ...
           int_value = Gauss_quadrature_for_line_integral_trial_test_lambda(coefficient_function, Gauss_weights_reference_1D, Gauss_nodes_reference_1D,...
              endpoint(:,1), endpoint(:,2), normal_vector, lable_test, vertices_1D, basis_type_trial_1D, alpha, derivative_degree_1D,...
              vertices, basis_type_test, beta, derivative_degree_x_test, derivative_degree_y_test);
