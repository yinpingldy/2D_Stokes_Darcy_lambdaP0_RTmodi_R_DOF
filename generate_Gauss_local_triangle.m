function [Gauss_weights_local_triangle,Gauss_nodes_local_triangle] = generate_Gauss_local_triangle(Gauss_coefficient_reference_triangle, Gauss_point_reference_triangle, vertices_triangle)
...
Gauss_weights_local_triangle = Gauss_coefficient_reference_triangle*Jacobi;
Gauss_nodes_local_triangle(:,1) = x1+(x2-x1)*Gauss_point_reference_triangle(:,1)+(x3-x1)*Gauss_point_reference_triangle(:,2);
Gauss_nodes_local_triangle(:,2) = y1+(y2-y1)*Gauss_point_reference_triangle(:,1)+(y3-y1)*Gauss_point_reference_triangle(:,2);
