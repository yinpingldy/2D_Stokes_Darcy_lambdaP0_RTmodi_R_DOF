function [result] = Gauss_quadrature_for_line_integral_test_2D_SRT0(coefficient_function, Gauss_weights_reference_1D, Gauss_nodes_reference_1D, normal_vector,...
    end_point_1, end_point_2, test_vertices, test_basis_index, test_derivative_degree)
